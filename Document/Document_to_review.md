...
_Data Visualization with JavaScript_
...
_The definitive guide on how to use static, class or abstract methods in Python_
...
_Brandon Craig Rhodes 的讲座“The Mighty Dictionary”散列表_
...
_Introduce to tornado_
<http://demo.pythoner.com/itt2zh/ch1.html#ch1-1>

_The difference between yield and yield-from_
...
_Python Mocks: a gentle introduction 2_
...
_Python 3: Variable Annotations_ **mypy in python3.6**
<http://www.blog.pythonlibrary.org/2017/10/31/python-3-variable-annotations/>

_How to make your code 80 times faster_
...
_Fear and Awaiting in Async: A Savage Journey to the Heart of the Coroutine Dream_
<https://www.youtube.com/watch?v=E-1Y4kSsAFc>

_Of Syntax Warnings and Symbol Tables_
<http://akaptur.com/blog/2014/06/11/of-syntax-warnings-and-symbol-tables/>

_Another Thing About Python's Threadlocals_
...
_Regular Expressions for Data Scientists_
...
_20 best Python questions at stackoverflow in 2017_ **regx_trie** **for \_ in itertools.repeat(None, count)**
...
_Copy-on-write friendly Python garbage collection_
<https://engineering.instagram.com/copy-on-write-friendly-python-garbage-collection-ad6ed5233ddf>

_Controlling Python Async Creep_  **need debug**
...
_Extending Python 3 in Go_  **not fast as native python because of cgo overhead**
...
_Ten Things I Wish I’d Known About bash_
...
_Jupyter notebooks and version control_
...
_Fastest way to generate a random-like unique string with random length in Python 3_  **random functions**
...
_Remove combinations that contains some values before even calculated_
<https://stackoverflow.com/questions/48616694/remove-combinations-that-contains-some-values-before-even-calculated>

_Python splitting list to sublists at given start/end keywords_
...
_5 speed improvements in Python 3.7_
...
_You Don't Have To Be a Workaholic To Win: 13 Alternative Ways To Stand Out_
